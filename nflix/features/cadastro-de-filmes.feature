...
Funcionalidade: Cadastro de filmes
    ...
    Sendo um gestor de catálago
    Posso cadastrar um novo filmes

    @new_movie
    Esquema do Cenario: Novo filme
        O gestor de catálgo cadastra um novo filme através do formulário,
        e um novo registro é inserido no catálgo Ninjaflix.
    ...
    Esquema do Cenario: Campos obrigatórios
        O gestor de catálago tenta cadastrar um novo filme, mas esquece
    ...
    @dup_movie
    Cenário: Diplicado
        O gestor de catálago tenta cadastrar um filme, porém o título
